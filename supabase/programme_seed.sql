...
with track as (
  ...
  values
    ...
    ('use_example', 'When to use AI and when not to — try it yourself', 'Apply the day''s technique to something on your own desk.', 1, 1, 'When to use AI and when not to', '{}'::jsonb),
    ...
    ('use_example', 'CRISP Framework — try it yourself', 'Apply the day''s technique to something on your own desk.', 2, 1, 'CRISP Framework', '{}'::jsonb),
    ('video', 'Connectors & MCP', null, 3, 0, 'Connectors & MCP', '{}'::jsonb),
    ('use_example', 'Connectors & MCP — try it yourself', 'Apply the day''s technique to something on your own desk.', 3, 1, 'Connectors & MCP', '{}'::jsonb),
    ...
    ('use_example', 'Projects — try it yourself', 'Apply the day''s technique to something on your own desk.', 4, 1, 'Projects', '{}'::jsonb),
    ('video', 'Catching confident wrong answers', null, 5, 0, 'Catching confident wrong answers', '{}'::jsonb),
    ('use_example', 'Catching confident wrong answers — try it yourself', 'Apply the day''s technique to something on your own desk.', 5, 1, 'Catching confident wrong answers', '{}'::jsonb),
    ...
    ('use_example', 'Research, Memory & files out — try it yourself', 'Apply the day''s technique to something on your own desk.', 6, 1, 'Research, Memory & files out', '{}'::jsonb),
    ...
    ('use_example', 'Cowork — try it yourself', 'Apply the day''s technique to something on your own desk.', 7, 1, 'Cowork', '{}'::jsonb),
    ('video', 'Skills', null, 8, 0, 'Skills', '{}'::jsonb),
    ('use_example', 'Skills — try it yourself', 'Apply the day''s technique to something on your own desk.', 8, 1, 'Skills', '{}'::jsonb),
    ('session', 'Live session 2', null, 8, 2, null, '{"slots":2}'::jsonb),
    ('video', 'Scheduled Tasks', null, 9, 0, 'Scheduled Tasks', '{}'::jsonb),
    ('use_example', 'Scheduled Tasks — try it yourself', 'Apply the day''s technique to something on your own desk.', 9, 1, 'Scheduled Tasks', '{}'::jsonb),
    ...
    ('use_example', 'Reverse Prompting — try it yourself', 'Apply the day''s technique to something on your own desk.', 10, 1, 'Reverse Prompting', '{}'::jsonb),
    ...
    ('use_example', 'Artifacts — try it yourself', 'Apply the day''s technique to something on your own desk.', 11, 1, 'Artifacts', '{}'::jsonb),
    ('video', 'Design', null, 12, 0, 'Design', '{}'::jsonb),
    ('use_example', 'Design — try it yourself', 'Apply the day''s technique to something on your own desk.', 12, 1, 'Design', '{}'::jsonb),
    ...
    ('use_example', 'Dispatch + Plugins — try it yourself', 'Apply the day''s technique to something on your own desk.', 13, 1, 'Dispatch + Plugins', '{}'::jsonb),
    ...
    ('use_example', 'Claude everywhere — try it yourself', 'Apply the day''s technique to something on your own desk.', 14, 1, 'Claude everywhere', '{}'::jsonb),
    ...
    ('use_example', 'Choosing the right tool + measuring time saved — try it yourself', 'Apply the day''s technique to something on your own desk.', 15, 1, 'Choosing the right tool + measuring time saved', '{}'::jsonb),
